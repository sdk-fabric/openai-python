...
class CompletionChoice(BaseModel):
    ...
    message: Optional[Annotated[Union[Annotated[CompletionMessageDeveloper, Tag('developer')], Annotated[CompletionMessageSystem, Tag('system')], Annotated[CompletionMessageUser, Tag('user')], Annotated[CompletionMessageAssistant, Tag('assistant')], Annotated[CompletionMessageTool, Tag('tool')]], Field(discriminator='role')]
